...
const data =  category.map((item, i) => {
    return <div className="p-3  bg-white cursor-pointer border border-grey0 lg:gap-3 justify-center flex items-center m-2 rounded-lg text-xl shadow-sm shadow-grey1">
